...
import {FetauresSlider} from './FetauresSlider';

export default function RecalimFeatures() {

    return (
        // <div ref={ref} className='px-20 h-[3000px] max-md:px-10 max-sm:px-5 flex flex-row max-md:flex-col items-center justify-center gap-20 py-20'>
        //     <div className='px-20 h-screen max-md:px-10 max-sm:px-5 flex flex-row max-md:flex-col items-center justify-center gap-20 py-20'>
