...
export default function RecalimFeatures() {
  return (
    <div className='px-20 max-md:px-10 max-sm:px-5 flex flex-row flex-wrap items-center justify-center gap-20 py-20'>
        <div className='w-[50%] flex flex-row justify-center'>
            <img className='h-[700px] max-lg:h-[500px]' src='images/features/usage-graph.png' />
        </div>
        <div className='flex flex-col max-lg:gap-10 gap-20 w-[40%] items-start'>
