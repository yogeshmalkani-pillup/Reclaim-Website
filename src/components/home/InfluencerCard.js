...
export default function InfluencerCard({ imageName, quote, key }) {
  return ( 
    <GlowingBorderCard containerClassName="w-[25%] max-md:w-[40%] max-sm:w-full rounded-[50px] " className="w-full h-full  rounded-[50px] py-10 px-5 flex flex-col justify-between items-stretch bg-zinc-900">
