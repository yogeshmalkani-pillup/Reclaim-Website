        ...
        <div className='w-full'>
            <div className={`w-full flex flex-row gap-10 flex-wrap justify-between px-20 py-28 max-md:p-10 max-sm:p-5 bg-[#111312] ${mulish.className}`}>
                <div className='flex flex-col gap-10 max-sm:gap-5 max-md:w-full ' >
                    <div className='flex flex-row items-center gap-2' onClick={() => setActivePage(HOME)}>
                ...
                <div className='flex flex-col gap-10 '>
                    ...
                    <div className='flex flex-col gap-2'>
                        <p className='text-[18px] max-sm:text-[15px] font-semibold cursor-pointer'>FAQs</p>
                        <p className='text-[18px] max-sm:text-[15px] font-semibold cursor-pointer'>Privacy Policy</p>
                        <p className='text-[18px] max-sm:text-[15px] font-semibold cursor-pointer' onClick={() => setActivePage(TERMSANDCONDITION)}>Terms of Use</p>
                    </div>
                </div>
